...
class MemberManager:
    ...
    def __init__(self):
        # MemberService 객체 생성 시 MemberDAO 객체를 전달하여 DB에 대한 의존성 주입
        self.ms = MemberService(MemberDAO())

    def main(self):
        self.show_welcome()
        # 테스트용
        # self.ms.join(Member('woongseok', '1234', '최웅석'))
        # self.ms.join(Member('cws', '1234', '웅석'))
        while True:
    ...
    # 회원 정보 보기
    def view_member_info(self, user_id):
        member = self.ms.view_member_info(user_id)
    ...
    def show_welcome(self):
        print('=' * 50)
        title = 'Woongseok Member Manager'
        print(f'{title:^50}')
        print('=' * 50)

    def say_goodbye(self):
        print('Woongseok Member Manager를 사용해주셔서 감사합니다.')
        print('안녕히 가세요')
